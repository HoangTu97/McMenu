...
export const NutritionSummaryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mcMenuApp.nutritionSummary.delete.question">
        <Translate contentKey="mcMenuApp.nutritionSummary.delete.question" interpolate={{ id: nutritionSummaryEntity.id }}>
