...
const apiSearchUrl = 'api/_search/ingredients';

// Actions

export const searchEntities = createAsyncThunk('ingredients/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
